...
//static uchar *stack; // Software stack for things that should go on the CPU stack
...
#ifdef FORCE_DESKTOP
static const uchar backspacemsg[]     = "\b \b";
#endif

# if 0
static const uchar initmsg[]          = "TinyBasic Plus " kVersion;
static const uchar indentmsg[]        = "    ";
static const uchar sderrormsg[]       = "SD card error.";
static const uchar sdfilemsg[]        = "SD file error.";
static const uchar dirextmsg[]        = "(dir)";
static const uchar slashmsg[]         = "/";
static const uchar spacemsg[]         = " ";
#endif

static int   inchar(void);
//static uchar inchar2(void);
static void  outchar(uchar c);
static void  line_terminator(void);
static S_INT expression(void);
static uchar breakcheck(void);
...
#ifdef FORCE_UEFI
			global_eST->ConOut->OutputString(global_eST->ConOut, L"\b \b");
#else
...
/****************************
static uchar inchar2()
{
#ifdef FORCE_DESKTOP
	return (uchar)getchar();
#else
	return (uchar)7;
#endif
}
